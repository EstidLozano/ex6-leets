			...
			public void call(Object... args) {
				...
				try {
					if (Constantes.SPACE_ID.equals(payload.getString("topicId")) //Si el mensaje es del espacio subscrito
							...
							&& payload.getJSONObject("content").getString("bodyText").toUpperCase().contains(Constantes.BOT)) { //y si el mensaje contiene @bot 
						
						//Obtenemos el mensaje de spaces
						String msgFromSpaces = payload.getJSONObject("content").getString("bodyText").toUpperCase().replace(Constantes.BOT, "");
